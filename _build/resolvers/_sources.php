...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            $properties = array(
                'name' => 'loginSetting',
                'description' => 'Default source for files of loginSetting',
                ...
                'properties' => array(
                    'basePath' => array(
                        ...
                        'type' => 'textfield',
                        'lexicon' => 'core:source',
                        'value' => 'assets/images/loginsetting/',
                    ),
            ...
            if ($setting = $modx->getObject('modSystemSetting', array('key' => 'loginsetting_source_default'))) {
